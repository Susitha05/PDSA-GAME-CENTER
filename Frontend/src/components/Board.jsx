        ...
        <div className="board-container" style={{ width: '600px', height: '600px' }}>
            ...
            <div className="overlay-container" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', overflow: 'hidden' }}>
                {snakes.map((s, i) => {
                    ...
                    if (rowDiff <= 3) {
                        asset = seed === 0 ? '/src/assets/1.png' : '/src/assets/2.png';
                    } else {
                        asset = seed === 0 ? '/src/assets/3.png' : '/src/assets/4.png';
                    }
                ...
                {ladders.map((l, i) => {
                    ...
                    if (rowDiff <= 3) {
                        asset = seed === 0 ? '/src/assets/5.png' : '/src/assets/6.png';
                    } else {
                        asset = seed === 0 ? '/src/assets/7.png' : '/src/assets/8.png';
                    }
