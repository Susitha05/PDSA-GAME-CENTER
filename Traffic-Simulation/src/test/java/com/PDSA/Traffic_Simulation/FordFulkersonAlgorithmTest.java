...
import com.PDSA.Traffic_Simulation.service.FordFulkersonAlgorithm;
import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Unit tests for Ford-Fulkerson Algorithm
 */
public class FordFulkersonAlgorithmTest {
    ...
    public void testSimpleGraph() {
        ...
        FordFulkersonAlgorithm algo = new FordFulkersonAlgorithm(graph, 0, 5);
    ...
    public void testDisconnectedGraph() {
        ...
        FordFulkersonAlgorithm algo = new FordFulkersonAlgorithm(graph, 0, 2);
        int maxFlow = algo.findMaxFlow();
    ...
    public void testTrafficNetworkGraph() {
        ...
        FordFulkersonAlgorithm algo = new FordFulkersonAlgorithm(graph, 0, 8);
        int maxFlow = algo.findMaxFlow();
    ...
    public void testMultiplePathsGraph() {
        ...
        FordFulkersonAlgorithm algo = new FordFulkersonAlgorithm(graph, 0, 4);
        int maxFlow = algo.findMaxFlow();
